...
class kg_robot():
    def __init__(self, port=False, ee_port=False, db_host=False, name='burt'):
        ...
        self.open=False
        if port!=False:
            # self.host = "169.254.254.158"  # Set to address from ipconfig
            # self.host = "10.0.2.88"  # Set to address from ipconfig
            self.host = "169.254.243.37"  # Set to address from ipconfig
    ...
    def movel(self, pose, acc=1, vel=0.5, min_time=0, radius=0, wait=True):
        """
