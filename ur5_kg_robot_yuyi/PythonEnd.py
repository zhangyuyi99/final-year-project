"""
    ...
    I've left everything here, but the only real takeaways are that this script connects to the UR5 each time it is called, 
    and that the arguments are extracted: float(sys.argv[12])
...
urnie = kgr.kg_robot(port=30010,db_host="169.254.88.50")
