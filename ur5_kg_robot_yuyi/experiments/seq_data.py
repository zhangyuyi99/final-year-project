...
with open('data/seq_data.txt', 'a') as f:
    for j in range(50,group_number):
        try:
            for i in range(seq_length):
                ...
                distance = random.uniform(0.00, 0.08)
                hold_time = random.uniform(0, 3)
                move_acc = random.uniform(0.1, 2)
                ...
                move_press_lift(note,move_vel,down_vel,up_vel,distance,hold_time,move_acc,down_acc,up_acc,press_depth)
